...
export const About: FC = () => (
  <Grid container direction={"row"} justifyContent="center" my={3}>
    <Grid item sm={6} container justifyContent={"end"} alignContent={"center"}>
      ...
      >
        <img
          src="https://firebasestorage.googleapis.com/v0/b/hassanalrawi-eb46f.appspot.com/o/Assets%2Fauthor.jpg?alt=media&token=95588295-ff97-42c2-9404-bfa425b84b27"
          style={{
            display: "block",
            maxWidth: "100%",
            // maxHeight: "100%",
